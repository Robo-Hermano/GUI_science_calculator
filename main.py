...
class Sci_Calculator:
  ...
  def circuit_diagrams(self):
    ...
    self.img1 = tk.Label(self.circuit_frame, img = Image.open("LDR.png"))
    ...
    self.img2 = tk.Label(self.circuit_frame, img = Image.open("bulb.png"))
    ...
    self.img3 = tk.Label(self.circuit_frame, img = Image.open("diode.png"))
    ...
    self.img4 = tk.Label(self.circuit_frame, img = Image.open("heater.png"))
    ...
    self.img5 = tk.Label(self.circuit_frame, img = Image.open("potentiometer.png"))
    ...
    self.img6 = tk.Label(self.circuit_frame, img = Image.open("thermistor.png"))
    ...
    self.img7 = tk.Label(self.circuit_frame, img = Image.open("variable_resistor.png"))
