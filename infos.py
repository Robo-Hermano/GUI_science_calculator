def get_infos():
  ...
  amino_acids["CAU"] = "Histidine"
  amino_acids["CAC"] = "Histidine"
  amino_acids["CAA"] = "Glutamine"
  amino_acids["CAG"] = "Glutamine"
  amino_acids["AAU"] = "Asparagine"
  amino_acids["AAC"] = "Asparagine"
  amino_acids["AAA"] = "Lysine"
  amino_acids["AAG"] = "Lysine"
  amino_acids["GAU"] = "Aspartic acid"
  amino_acids["GAC"] = "Aspartic acid"
  amino_acids["GAA"] = "Glutamic acid"
  amino_acids["GAG"] = "Glutamic acid"
  amino_acids["UGU"] = "Cysteine"
  amino_acids["UGC"] = "Cysteine"
  amino_acids["UGA"] = "STOP"
  amino_acids["UGG"] = "Tryptophan"
  amino_acids["CGU"] = "Arginine"
  amino_acids["CGC"] = "Arginine"
  amino_acids["CGA"] = "Arginine"
  amino_acids["CGG"] = "Arginine"
  amino_acids["AGU"] = "Serine"
  amino_acids["AGC"] = "Serine"
  amino_acids["AGA"] = "Arginine"
  amino_acids["AGG"] = "Arginine"
  amino_acids["GGU"] = "Glycine"
  amino_acids["GGC"] = "Glycine"
  amino_acids["GGA"] = "Glycine"
  amino_acids["GGG"] = "Glycine"

  circuit_definitions["Bulb"] = "Literally just a bulb. As p.d. increases resistance increases, due to increased heat and kinetic energy of electrons therefore electrons bump into each other. Not an ohmic component"
  ...
  return constants_dictionary, amino_acids, circuit_definitions, molecule_tests
